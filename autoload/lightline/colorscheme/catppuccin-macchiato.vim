let s:c = has("nvim") == 1 ? luaeval('require("catppuccin.palettes").get_palette("macchiato")') : luaeval('vim.dict(require("catppuccin.palettes").get_palette("macchiato"))')
...
let g:lightline#colorscheme#catppuccin_macchiato#palette = lightline#colorscheme#fill(s:p)